...
OLD_PROMPT_PATH = ROOT / "prompts/translated_sentence_annotation_prompt_short.md"
...
def historiography_prompt() -> str:
    ...
    task_marker = "You are given an existing interpretive summary of the page and ordered pairs"
        ...
        for index, triple in enumerate(group.triples, start=1):
            for field in ("subject", "predicate", "object"):
                ...
                if value.lower() in forbidden_values:
                    errors.append(f"{group.sid} triple {index}: invalid {field} value")
